...
public class Payment {
	...
	private int campaign_id; //Discount campaign ID 
	...
	private int differential_pricing_id; //Id of the scheme for the absorption of financing fee 
	...
	private boolean capture; //Determines if the payment should be captured (true, default value) or just reserved (false)
	...
	private int installments; //Selected quantity of installments
	...
	public int getDifferential_pricing_id() {
		return differential_pricing_id;
	}
	public void setDifferential_pricing_id(int differential_pricing_id) {
